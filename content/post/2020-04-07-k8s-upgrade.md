...
author: "kaisawind"
description: "CentOS7使用kubeadm平滑升级"
---
CentOS7使用kubeadm平滑升级

> **注意**: 本文档基于Kubernetes 1.16版本编写，部分命令已过时。最新升级指南请参考：https://kubernetes.io/docs/tasks/administer-cluster/kubeadm/kubeadm-upgrade/
<!--more-->
...
## 2. 升级
官方说明文档：https://kubernetes.io/docs/tasks/administer-cluster/kubeadm/kubeadm-upgrade/
